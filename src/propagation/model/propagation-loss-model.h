...
private:
	  /**
	     ...
	     * Defined and unimplemented to avoid misuse
	     */
	  NLOSPropagationLossModel (const NLOSPropagationLossModel&);
	  /**
	   * \brief Copy constructor
	   *
	   * Defined and unimplemented to avoid misuse
	   * \returns
	   */
	  NLOSPropagationLossModel& operator= (const NLOSPropagationLossModel&);
	  virtual double DoCalcRxPower (double txPowerDbm,
	                                  Ptr<MobilityModel> a,
	                                  Ptr<MobilityModel> b) const;
	  virtual int64_t DoAssignStreams (int64_t stream);
...
//Hybrid Model for LOS/NLOS
class LOSNLOSPropagationLossModel : public PropagationLossModel
{
public:
	/**
	   * \brief Get the type ID.
...
private:
	  /**
	     ...
	     * Defined and unimplemented to avoid misuse
	     */
	  LOSNLOSPropagationLossModel (const LOSNLOSPropagationLossModel&);
	  /**
	   * \brief Copy constructor
	   *
	   * Defined and unimplemented to avoid misuse
	   * \returns
	   */
	  LOSNLOSPropagationLossModel& operator= (const LOSNLOSPropagationLossModel&);
	  virtual double DoCalcRxPower (double txPowerDbm,
	                                  Ptr<MobilityModel> a,
	                                  Ptr<MobilityModel> b) const;
	  virtual int64_t DoAssignStreams (int64_t stream);
	  static double PathLoss (double d1, double d2, double frequency);

	  static double PathLossLOS (double distance, double frequency);
