...
private:
  ...
  /**
   * Current frame number: added by adel
   */
  uint32_t m_FrameNo;
  /**
   * Current subframe number: added by adel
   */
    uint32_t m_SubframeNo;
  /*
   * list of reserved resources: added by adel
   */
  //std::list < std::pair< std::pair<int,int>,int > > m_allreservedresources;
  std::list < std::pair< std::pair<int,int>,std::pair<int,int> > > m_allreservedresources;
