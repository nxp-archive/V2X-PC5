...
//added by adel
class SpectrumValue;
class SidelinkCommResourcePool;
...
public:
  ...
  */
   ...
   * added by adel
   */
  virtual void CalculateReceivedSignal (Ptr<SpectrumValue> signal) = 0;

  /*
   * added by adel
   */
  //virtual void GetAllReservedResources(std::list< std::pair< std::pair<int,int>, int > > ReservedResources) = 0;
  virtual void GetAllReservedResources(std::list < std::pair< std::pair<int,int>,std::pair<int,int> > > ReservedResources) = 0;
