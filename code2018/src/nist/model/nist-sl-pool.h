...
namespace ns3 {
  ...
  public:
    ...
    /**
    * Configure the pool for v2x using the content of the preconfigured pool
    * Parsing the message will indicate whether it is a scheduled or UE selected pool
    * \param pool The message containing pool information
    */
     void SetPoolV2X (NistLteRrcSap::SlPreconfigCommPool pool);
    ...
    /**
     * Returns the subframe and resource block allocations of the transmissions in
     * PSCCH for the given resource for LTE V2X
     * \param n the selected resource within the pool
     *
     * \return The list of transmission information
     */
    std::list<SidelinkCommResourcePool::SidelinkTransmissionInfo> GetPscchTransmissionsV2X (uint32_t time, uint32_t subch);
     ...
     * \return the subframes and RBs associated with the transmission on PSSCH
     */
     std::list<SidelinkCommResourcePool::SidelinkTransmissionInfo> GetPsschTransmissionsV2X (uint32_t time, uint32_t subch, uint32_t subchsize);;
  ...
  protected:
    ...
    /**
         * Translates the filtered subframes to subframe numbers relative to the current
         * frame/subframe
         */
    //SidelinkCommResourcePool::SidelinkTransmissionInfo TranslatePscchV2X (SidelinkCommResourcePool::SidelinkTransmissionInfo info);
  ...
  public:
    ...
    /**
    * Configure the V2X pool using the content of the preconfigured pool
    * \param pool The message containing the pool information
    */
    void SetPoolV2X (NistLteRrcSap::SlPreconfigCommPool pool);
